            ...
            filteredSessions.map((session) => (
              ...
              >
                ...
                <div className="flex items-center gap-1.5 mt-1 text-[10px] font-bold text-zinc-400 uppercase tracking-wider">
                  ...
                  {new Date(Number(session.last_active)).toLocaleDateString(undefined, { month: 'short', day: 'numeric' })} at {new Date(Number(session.last_active)).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                </div>
              </button>
            ))
          )}
