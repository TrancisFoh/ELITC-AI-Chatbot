        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
          ...
          >
            <div className="p-8 border-b border-zinc-100 flex items-center justify-between bg-gradient-to-r from-zinc-50 to-white">
              <div>
                <h2 className="text-xl font-bold text-zinc-900">{!(course as any)._isNew ? 'Edit Course' : 'New Course'}</h2>
            ...
            <div className="p-8 overflow-y-auto flex-1 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <label htmlFor="course-url" className="text-[11px] font-bold text-zinc-400 uppercase tracking-widest px-1">Course Link (URL)</label>
                  <input
                    id="course-url"
                    type="url"
                    placeholder="https://www.elitc.com/..."
                    value={course.url || ''}
