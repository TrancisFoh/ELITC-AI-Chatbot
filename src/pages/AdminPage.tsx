...
export default function AdminPage() {
  ...
  useEffect(() => {
    ...
    const unsubCourses = dbService.subscribeToCourses(setCourses);
    const unsubConfigs = dbService.subscribeToConfigs(setConfigs);
  ...
  const handleMigrate = async () => {
    if (!confirm('This will synchronize courses and default instructions to Firestore. Continue?')) return;
